...
<form method="post" action="<?=domain ;?>/admin-newsletter/message_all_subscribers">
  ...
  <div class="col-lg-4 form-group has-feedback">
    <input class="form-control has-feedback-left btn-primary" id="inputSuccess2" type="submit" value="Send">
  </div>
...
dataString = "newsletter_id="+newsletter_id;
        ...
        $.ajax({
            type: "POST",
            url: "<?=domain;?>/admin-newsletter/delete_newsletter/",
            data: dataString,
            cache: false,
