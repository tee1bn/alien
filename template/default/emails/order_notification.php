            ...
            <tbody>
                <tr>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td class="esd-block-text" align="right">
                                                                                                                        <p><a target="_blank" style="font-size: 18px; line-height: 120%;" href="<?=domain;?>/shop">Shop</a></p>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                                                    ...
                                                                                                    <td class="esd-block-image es-p10l" valign="top" align="left">
                                                                                                        <a href="<?=domain;?>" target="_blank"><img src="https://tlr.stripocdn.email/content/guids/CABINET_75694a6fc3c4633b3ee8e3c750851c02/images/77981522050090360.png" alt="" style="display: block;" width="27"></a>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-p25t es-p25b es-p35r es-p35l" align="center">
                                                                                        <a target="_blank" href="<?=domain;?>/shop/open_order_confirmation/<?=$order->id;?>"> <img src="https://tlr.stripocdn.email/content/guids/CABINET_75694a6fc3c4633b3ee8e3c750851c02/images/67611522142640957.png" alt="" style="display: block;" width="120"> </a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                    ...
                    <p class="stext-107 cl7 size-201">
                         <!-- <?=$contact->address;?> <br> -->
                          Phone: <a href="mailto://<?=$contact->phone;?>"><?=$contact->phone;?></a><br>
                                                                    ...
                                                                    <td class="esd-container-frame" width="530" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p30t es-p15b es-p10r es-p10l" align="center"> <span class="es-button-border"> <a href="<?=domain;?>/shop" class="es-button" target="_blank">Awesome</a> </span> </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-c es-p5b" esdev-links-color="#777777" align="left">
                                                                                        <p style="color: #777777;">If you didn't create an account using this email address, please ignore this email or&nbsp;<u><a target="_blank" style="color: #777777;" href="<?=domain;?>">unsubscribe</a></u>.<br></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
