		...
		<!-- 	<div class="row p-b-5">
				<div class="col-md-12 col-lg-12">
					<div class="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
						...
						<p class="stext-113 cl6 p-b-10" <?=$this->allow_contenteditable('$page_cms[0].textcontent');?>>
						</p>
		...
		<div id="ceo_div" class="row p-b-5">
				<div class="col-md-12 col-lg-12">
					<div class="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
						...
						font-size: 16px;
    text-align: justify;
    " class="stext-113 cl6 p-b-10" <?=$this->allow_contenteditable('$page_cms[1].textcontent');?>>
						</p>
