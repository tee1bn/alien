                    ...
                    <div class="row pt--75 pt-md--55 pt-sm--35 pb--80 pb-md--60 pb-sm--40">
                        <div class="col-md-12 mb-sm--30">
                            <div class="login-box">
                                ...
                                <form action="<?=domain;?>/forgot-password/send_link" method="post" class="form form--login">
                            <?=$this->inputError('user_login');?>
                                    <div class="form__group mb--20">
                                        <label class="form__label form__label--2" for="username_email">Email address
                                         <span class="required">*</span></label>
                                        <input required="" type="email" class="form__input form__input--3" id="username_email" name="user">
                                    </div>
